...
public class UserProfileEndpointTest : IDisposable
{
    private readonly ServiceProvider _serviceProvider;
    private readonly AuthDbContext _context;
    private readonly string _token;

    public UserProfileEndpointTest()
    {
        ...
        _token = SetupTestDataAndGenerateTokenAsync().Result;
    }

    private async Task<string> SetupTestDataAndGenerateTokenAsync()
    {
    ...
    public async Task GetCurrentUser_WithValidToken_ReturnsOk()
    {
        ...
        var userProfile = Assert.IsType<UserDto>(okResult.Value);
        Assert.Equal("profiletestuser", userProfile.Username);
    }
